...
pub fn udivmod(comptime DoubleInt: type, a: DoubleInt, b: DoubleInt, maybe_rem: ?*DoubleInt) DoubleInt {
    ...
    const SingleInt = @import("../../std.zig").meta.Int(.unsigned, single_int_bits);
    const SignedDoubleInt = @import("../../std.zig").meta.Int(.signed, double_int_bits);
    const Log2SingleInt = @import("../../std.zig").math.Log2Int(SingleInt);
